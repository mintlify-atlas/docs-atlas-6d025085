...
Found a bug in an existing agent? Please open an issue on our [GitHub repository](https://github.com/alanbuscaglia/claude-agents) with:
...
<Steps>
  <Step title="Fork the Repository">
    Fork the [claude-agents repository](https://github.com/alanbuscaglia/claude-agents) to your GitHub account.
  </Step>
...
- Open a [GitHub Discussion](https://github.com/alanbuscaglia/claude-agents/discussions)
